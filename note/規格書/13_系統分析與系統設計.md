...
| 效能 | 決策逾時預算 | 單一全域 `DEFAULT_TIMEOUT` 10 秒（`ai_config.gd`，非分 provider，見《99》P-11） | 《12》§9、《04》§6 |
...
| 商店 `buy_from()` 機制 | 機制本身正確（扣款＋加物品原子成立），商品清單已是《08》§0 拍板的正式清單（#166／#165 已關閉，2026-08-23 查證 `vending_machine.gd` 已含 `cooked_meat` 等 MVP 5 樣，酒類確實累加 `alcohol`） |
