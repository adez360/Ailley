...
| 效能 | 決策逾時預算 | 單一全域 `DEFAULT_TIMEOUT` 10 秒（`Ailley/scripts/ai/ai_config.gd`，非分 provider，見《99》P-11） | 《12》§9、《04》§6 |
...
| 死亡／墓園全套（《09》） | 之後 | 「昏迷」先頂著跑；正式死亡／安葬／墓園系統留到 MVP-2 之後——**現況（2026-08-24 查證）**：這裡的「之後」是本文件原始規劃，issue #368（2026-08-20）後來把這塊拉進跟化身者同一波在做，是這學期 MVP 的一部分，以《17》「化身者與死亡系統」小節為準，不是這一列過期，是後來的優先序調整 | 之後（實際已提前開工，見《17》） |
