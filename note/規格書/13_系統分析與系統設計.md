...
| 死亡／墓園全套（《09》） | 之後 | 「昏迷」先頂著跑；正式死亡／安葬／墓園系統留到 MVP-2 之後——**現況（2026-08-24 查證）**：這裡的「之後」是本文件原始規劃，issue #368（2026-08-20）後來把這塊拉進跟化身者同一波在做，實際排程已經超前本表，以《17》「目前位置」為準，不是這一列過期，是後來的優先序調整，見該文件已解決附註 | 之後（實際已提前開工，見《17》） |
