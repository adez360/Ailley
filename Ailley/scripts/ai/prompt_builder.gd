...
For "murmur", params must be {"line": "<the short thing you mutter to yourself, in your own words>"} — thinking out loud, not addressed to anyone. Nearby characters don't hear it as speech.
