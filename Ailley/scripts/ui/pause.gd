...
## 順序無關；其餘會攔 ui_cancel 的面板（status_panel、inventory_panel、
## character_create……）都走 _unhandled_input，只要它們是 PersistentUI 底下
## 排在 Pause 之後的子節點、且自己 set_input_as_handled()，就會比 Pause 先
