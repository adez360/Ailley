...
## 完整墨磑內容（last_words／life_highlights／既有悼詞列表）的面板，
...
func _input(event: InputEvent) -> void:
	...
	# 世界選取邏輯恆走（跟 status_panel.gd 同一個理由）
